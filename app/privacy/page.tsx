...
export const metadata: Metadata = {
  title: "Privacy",
  description: `How ${siteConfig.person.name}'s portfolio handles personal information. This site does not use advertising cookies or collect form submissions.`,
  alternates: {
    canonical: "/privacy",
  },
  openGraph: {
    title: `Privacy — ${siteConfig.person.name}`,
    description: `How ${siteConfig.person.name}'s portfolio handles personal information.`,
    url: "/privacy",
    type: "website",
...
export default function PrivacyPage() {
  return (
    <>
      <JsonLd pathname="/privacy" />
      <SiteHeader />
      <main id="main" className="mx-auto max-w-3xl flex-1 px-4 py-16 sm:px-6 lg:px-8">
